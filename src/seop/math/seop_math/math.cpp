...
namespace seop::math
{
    ...
    Matrix Matrix::CreateLookAt(const Vec3 &eye, const Vec3 &target, const Vec3 &up) noexcept
    {
        ...
        return Matrix(
            xAxis.x_, yAxis.x_, zAxis.x_, 0.0f,                     // 1열 (_00, _01, _02, _03)
    ...
    {
        return Vec4{
            _00 * v.x_ + _10 * v.y_ + _20 * v.z_ + _30 * v.w_,
            _01 * v.x_ + _11 * v.y_ + _21 * v.z_ + _31 * v.w_,
            _02 * v.x_ + _12 * v.y_ + _22 * v.z_ + _32 * v.w_,
            _03 * v.x_ + _13 * v.y_ + _23 * v.z_ + _33 * v.w_};
    }
    ...
    auto Matrix::Invert() const noexcept -> Matrix
    {
        ...
        // |_30  _31  _32 _33|
        return Matrix{
            Determinant3x3(_11, _21, _31, _12, _22, _32, _13, _23, _33) * invDet,
    ...
    auto Matrix::Determinant3x3(float m00, float m10, float m20,
                                float m01, float m11, float m21,
                                float m02, float m12, float m22) const -> float
    {
        // |_00  _01  _02 |
        // |_10  _11  _12 |
        // |_20  _21  _22 |
