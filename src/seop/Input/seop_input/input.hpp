...

{
  public:
    ...
    void init();
    void update(window::Glf_window &window);
    void reset();
  ...
  private:
    void update_cursor_pos(window::Glf_window &window);
    void update_mouse(window::Glf_window &window);
    void update_mouse_button(window::Glf_window &window, int glfw_button, Key_code code);
    void update_keys(window::Glf_window &window);
    void update_key(Key &key, window::Glf_window &window);
